...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('target_frame_id', default_value='target'),
        DeclareLaunchArgument('target_pose_topic', default_value='/car/target_pose'),
        DeclareLaunchArgument('publish_target_pose', default_value='true'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'publish_target_pose': LaunchConfiguration('publish_target_pose'),
