...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('path_spacing_m', default_value='0.03'),
        ...
        DeclareLaunchArgument('waypoint_tolerance_m', default_value='0.08'),
        DeclareLaunchArgument('goal_tolerance_m', default_value='0.10'),
        DeclareLaunchArgument('k_w', default_value='1.8'),
        DeclareLaunchArgument('w_max_rad_s', default_value='0.6'),
